...
class tareaspendientes_controller extends CI_Controller
{
    ...
    { 
        ...
        $opcion_menu='tareas_pendientes';
        
        
        
        $this->session->set_userdata('opcion_menu',$opcion_menu);
        $this->session->set_userdata('titulo_pagina','Tareas Pendientes');
      
        
        $limit_tareas=$this->limit_tareas;
        
        $tareas=$this->tareas_model->mostrarTareasPorEstado(1);
