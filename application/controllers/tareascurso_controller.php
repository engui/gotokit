...
class tareascurso_controller extends CI_Controller
{
    ...
    { 
        ...
        $opcion_menu='tareas_curso';
        
        
        
        $this->session->set_userdata('opcion_menu',$opcion_menu);
        $this->session->set_userdata('titulo_pagina','Tareas en Curso');
      
        
        $limit_tareas=$this->limit_tareas;
        
        $tareas=$this->tareas_model->mostrarTareasPorEstado(2);
