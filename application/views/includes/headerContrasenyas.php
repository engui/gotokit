...
<html>
    ...
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/colorpicker/jscolor.js"></script>
...
<div class="container gotocontainer">
    ...
    <div class="header">
        ...
        <div class="col-lg-12 text-center mt-5">
            ...
            <img class="mb-4" src="<?php echo base_url(); ?>assets/images/logo-agenda-verde.png" alt="" width="auto" height="72">
